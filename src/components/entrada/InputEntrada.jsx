...
function InputEntrada({ label, type, esqueceuSenha = false, funcao}) {
    ...
    return ( 
        <>
            <div className="mt-[.5rem] flex flex-col">
                ...
                <input onChange={e => funcao(e.target.value)} className="h-[2.5rem] rounded-2xl bg-[#EDEDED] border-2 border-[#A9B7CC] p-3" type={type} />
